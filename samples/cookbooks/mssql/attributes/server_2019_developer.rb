default['gusztavvargadr_mssql']['server']['2019_developer'] = {
  ...
  'patch_file_url' => 'http://download.windowsupdate.com/d/msdownload/update/software/updt/2021/10/sqlserver2019-kb5005679-x64_a6e4ec3e93be461565550973f8b8cdfdd5580967.exe',
}
