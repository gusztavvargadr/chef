default['gusztavvargadr_mssql']['server']['2019_developer'] = {
  ...
  'patch_file_url' => 'https://catalog.s.download.windowsupdate.com/d/msdownload/update/software/updt/2022/04/sqlserver2019-kb5011644-x64_a38427fc9ed638fdbc0011be2c71a7b32f811b9e.exe',
}
