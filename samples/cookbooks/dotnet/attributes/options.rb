default['gusztavvargadr_dotnet']['options']['tools']['runtime:10.0'] = {
  'windows' => {
    'package' => 'dotnet-10.0-runtime',
  },
  'ubuntu' => {
...
default['gusztavvargadr_dotnet']['options']['tools']['runtime:latest'] = default['gusztavvargadr_dotnet']['options']['tools']['runtime:10.0']
default['gusztavvargadr_dotnet']['options']['tools']['runtime'] = default['gusztavvargadr_dotnet']['options']['tools']['runtime:latest']

default['gusztavvargadr_dotnet']['options']['tools']['sdk:10.0'] = {
  'windows' => {
    'package' => 'dotnet-10.0-sdk',
  },
  'ubuntu' => {
...
default['gusztavvargadr_dotnet']['options']['tools']['sdk:latest'] = default['gusztavvargadr_dotnet']['options']['tools']['sdk:10.0']
