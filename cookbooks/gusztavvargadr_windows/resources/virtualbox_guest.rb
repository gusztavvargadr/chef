property :version, String, default: node['gusztavvargadr_windows']['virtualbox_guest']['version']

action :install do
  directory_path = "#{Chef::Config[:file_cache_path]}/gusztavvargadr_windows/virtualbox_guest"
