...
property :user, String, default: node['gusztavvargadr_windows']['powershell_script_elevated']['username']
property :password, String, default: node['gusztavvargadr_windows']['powershell_script_elevated']['password']
